      ...
      <div class="flex justify-between items-center px-6 sm:px-0">
        ...
        <div class="sm:hidden">
          ...
          <div
            @click="themeSwitcher"
            role="button"
            class="sm:hidden cursor-pointer inline-block mr-1 pb-0.5"
          >
            <!-- Dark mode icon -->
            <svg
              v-if="$colorMode.value == 'light'"
              xmlns="http://www.w3.org/2000/svg"
              class="text-gray-500 hover:text-gray-600 dark:text-liText-ternary-light dark:hover:text-li border-primary-light w-6 h-6"
              fill="none"
              viewBox="0 0 24 24"
              stroke="currentColor"
            >
