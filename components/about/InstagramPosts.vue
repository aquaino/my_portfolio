...
<template>
  <div class="block mt-10 sm:mt-20" v-if="posts">
    <!-- Instagram posts grid -->
    <div
      class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 2xl:grid-cols-6 gap-6 mt-6"
    >
      <a
        v-for="post in posts"
        :key="post.id"
      ...
      >
        <div
          class="relative bg-cover bg-center rounded-xl shadow-lg hover:shadow-xl w-80 md:w-56 lg:w-48 h-80 md:h-56 lg:h-48 mx-auto"
